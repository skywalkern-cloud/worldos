...
DIMENSION_CONFIG = [
    {
        ...
        'icon': '📈',
        'weight': 1.0,
        'indicators': ['chinaGdp', 'chinaPmi', 'usGdp', 'servicePmi', 'electricity', 'usNonFarm'],
    },
    {
        'id': 'inflation',
        'name': '通胀与政策',
    ...
    },
    {
        ...
        'icon': '💧',
        'weight': 0.8,
        'indicators': ['lpr', 'dr007', 'm2', 'creditSpread', 'dollarIndex', 'usBond2Y', 'usBond5Y', 'usBond10Y'],
    },
    {
        'id': 'sentiment',
        'name': '市场情绪',
